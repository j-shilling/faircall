...
static const yytype_uint8 yyrline[] =
{
      ...
      52,    53,    54,    55,    59,    63,    75,    88,   101,   112,
     123,   137,   154,   168,   177,   191,   203,   215,   233,   234,
...
{
  "$end", "error", "$undefined", "ADD", "DELETE", "INFO", "LIST", "OPEN",
  "CLOSE", "UNDO", "ABSENT", "EVEN", "CALL", "HELP", "QUIT", "NAME",
  "BOOL", "INT", "$accept", "cmd", "quit", "open", "add", "delete",
  "close", "even", "info", "call", "undo", "absent", "list", "help", YY_NULLPTR
};
#endif
